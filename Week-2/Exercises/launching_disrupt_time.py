...
for x in range(-400, -40, 5): #move the red square to the left by 5 pixels, every 1ms until it reaches position of the green square
...
exp.clock.wait(115) 
#125 ms still disrupt my impression of causality. 115 don't
